...
<head>
    ...
    <head lang="es">
        ...
        <script src="https://kit.fontawesome.com/a156713fcd.js" crossorigin="anonymous"></script>
                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <h5 class="p-2 text-center bg-primary"><?= $_SESSION["name"]. " " . $_SESSION["lastName"] ?></h5>
                                    <a class="dropdown-item" href=""><span class="font-icon glyphicon glyphicon-user"></span>Profile</a>
                                    <a class="dropdown-item" href=""><span class="font-icon glyphicon glyphicon-lock"></span>Change password</a>

                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="http://localhost/sis-asistencia/controller/controller_sign_off.php">
                                        <span class="font-icon glyphicon glyphicon-log-out"></span>Sign off
                                    </a>
                                </div>
                            </div>
                        </div>
